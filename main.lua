...
local customEmotes = {
    ...
    {Name = "Mean Mug - Tommy Hilfiger", Id = 10214415687, Price = 0, Index = 119},
...
-- Step 4: Display in final order
for i, Emote in ipairs(totalEmotes) do
